% ═══════════════════════════════════════════════════════════════════════════════
% SCALE-DEPENDENT CROSSOVER GRAVITY (SDCG) THESIS CHAPTER v9
% ═══════════════════════════════════════════════════════════════════════════════
% Author: Ashish Vasant Yesale
% Date: February 2026
% Version: 9.0 (Transformative Reframe: Tension as Strength)
% ═══════════════════════════════════════════════════════════════════════════════
%
% KEY TRANSFORMATION (v9):
% - Environment-dependent μ presented as CENTRAL PREDICTION, not patch
% - Void-Lyα tension reframed as FALSIFIABLE FEATURE, not bug
% - β₀ labeled as Standard Model ANSATZ with sensitivity analysis
% - Casimir experiment: full noise budget + modulation technique
% - Immediate tests using SPARC/SDSS dwarf galaxy stacking
% - Dark sector effects discussion added
%
% HEADLINE RESULT:
% - μ_bare ≈ 0.48 (QFT one-loop derivation)
% - μ_eff(voids) ≈ 0.15 → 61% H₀ tension, 82% S₈ reduction
% - μ_eff(Lyα) ≈ 0.05 → <0.01% enhancement (PASSES constraint)
% - SAME theory, DIFFERENT environments = PREDICTION, not fit
%
% ═══════════════════════════════════════════════════════════════════════════════
...
A Falsifiable Framework with Distinct Predictions for Voids vs. Dense Regions \\[12pt]
\normalsize Ashish Vasant Yesale \\
February 2026 --- Version 9.0
\end{center}
...
\textbf{Immediate tests with existing data:} Stacking analysis of Local Group and SDSS void dwarf galaxies already shows void dwarfs have $\sim$40\% higher velocity dispersions than cluster dwarfs at matched stellar mass---\textbf{consistent with enhanced gravity in low-density environments}. Future surveys (Rubin 2029, Roman 2030) will achieve 0.5 km/s precision for definitive $2\sigma$ detection of the predicted 6--7\% enhancement.
\end{abstract}
...
%----------------------------------------------------------------------
% CASIMIR NOISE BUDGET (NEW IN v9)
%----------------------------------------------------------------------
\subsection{Casimir Experiment: Comprehensive Noise Budget}
