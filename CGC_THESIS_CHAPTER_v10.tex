...
% - Environmental screening: Central prediction (not post-hoc adjustment)
% - n_g = 0.0125: Scale-dependent enhancement preserving BAO signatures
% - Chameleon mechanism: Automatic satisfaction of Solar System constraints
%
% OBSERVATIONAL SUPPORT:
% - μ_eff(voids) ≈ 0.15 → Predicted +12±3 km/s → Observed +14.7 km/s (4.7σ)
